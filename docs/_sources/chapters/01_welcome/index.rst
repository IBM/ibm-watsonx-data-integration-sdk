...
If you already have the SDK installed and are ready to get started, please refer to the :ref:`Getting Started<getting_started_and_tutorials>` section of the documentation.

Looking for documentation on the SDK's interfaces and abstractions? See the :ref:`API Reference Documentation<api_ref>` for an in-depth breakdown of the SDK's classes, properties, and methods, including detailed descriptions of required and optional parameters.
