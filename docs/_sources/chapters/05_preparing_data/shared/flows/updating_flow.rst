...
In the SDK, you can make changes to a :py:class:`~ibm_watsonx_data_integration.cpd_models.flow_model.Flow` instance
in memory and update it by passing that object to the :py:meth:`Project.update_flow() <ibm_watsonx_data_integration.cpd_models.project_model.Project.update_flow>` method.
