.. _projects__project_collaborators:
...
.. _projects__project_collaborators_listing_collaborators:
...
.. image:: /_static/images/projects/project_collaborators/access_control.png
...
.. _projects__project_collaborators_adding_collaborators:
...
There are four types of collaborators you can add to a project:
    * :ref:`User Profiles <access_control__users>`
    * :ref:`Access Groups <access_control__access_groups>`
    * :ref:`Service IDs <access_control__service_ids>` (SaaS only)
...
.. _projects__project_collaborators_updating_collaborators:
...
.. _projects__project_collaborators_removing_collaborators:
