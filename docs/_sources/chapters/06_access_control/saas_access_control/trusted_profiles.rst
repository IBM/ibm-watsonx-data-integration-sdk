...
that enables you to manage trusted profiles under your account. The SDK provides functionality for interacting with the
trusted profile API.
...
In the SDK, trusted profiles can be retrieved using the :py:attr:`Platform.trusted_profiles <ibm_watsonx_data_integration.platform.Platform.trusted_profiles>` property.
This property returns a :py:class:`~ibm_watsonx_data_integration.cpd_models.trusted_profile_model.TrustedProfiles` object.
